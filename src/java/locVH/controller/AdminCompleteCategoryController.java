 ...
 * @author LocVH
 */
public class AdminCompleteCategoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int CategoryID = Integer.parseInt(request.getParameter("txtCategoryName")); 
            ...
            for(ProductDTO dto : shoppingCart.getShoppingCart().values()) {
                ...
                productDAO.CategoryProduct(CategoryID, productId);
            }
            shoppingCart.getShoppingCart().clear();
            url = SUCCESS;
        } catch (Exception e) {
            log("ERROR at AdminCompleteUOrderController: " + e.getMessage());
        } finally {
