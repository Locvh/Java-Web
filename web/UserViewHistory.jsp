                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hb-menu">
                                    <nav>
                                        <ul>
                                            <li class="dropdown-holder"><a href="UserController?action=View History">Lịch sử mua hàng</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                            <h1 class="mb-5">Hello User, ${sessionScope.USER}</h1>
                            <h2 class="mb-5">Mời bạn xem lại lịch sự mua hàng</h2>
                        </div>
                    </div>
