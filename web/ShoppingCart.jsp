                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hb-menu">
                                    <nav>
                                        <ul>
                                            <li><a href="UserController?action=Shopping">Cửa hàng sản phẩm</a></li>                       
                                        </ul>
                                    </nav>
                                </div>
            ...
            <div class="breadcrumb-area">
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            <li><a href="UserController?action=Shopping">Shopping Products</a></li>
                ...
                <div class="container">    
                    ...
                    <form action="UserController" method="POST">
                        <table border="1" cellspacing="0" cellpadding="20" style="margin-left: 100px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Tổng tiền: <%= shoppingCart.getTotal()%></td>
                                    <td></td>
                                </tr>                                
                            </tbody>
                        </table> 
                        ...
                        <div class="default-btn slide-btn">
                            ...
                            <a class="links" href="UserController?action=Shopping" style="margin-left: 100px">Back to Shopping</a>
                        </div>
                    </form> 
