<%@page import="locVH.models.Cart"%>
<%@page import="locVH.dto.ProductDTO"%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="AdminController?action=category">
            ...
            <div class="breadcrumb-area">
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            <li><a href="AdminController?action=category">Categories</a></li>
                ...
                <div class="container">    
                    ...
                    <div class="row">
                        <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                            <h2 class="mb-5"><%= shoppingCart.getCustomerName()%>'s Categories</h2>
                        </div>
                    </div>
                    ...
                    <form action="AdminController" method="POST">
                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label class="font-weight-bold" for="CategoryName">Tên danh mục</label>
                                <select name="txtCategoryName">
                                    <option value="1">Hàng bán chạy</option>
                                    <option value="2">Hàng giá rẻ</option>
                                    <option value="3">Hàng giới hạn</option>
                                    <option value="4">Trở lại bình thường</option>                                
                                </select>                                                           
                            </div>
                        </div>
                        ...
                        <div class="default-btn slide-btn">
                            ...
                            <a class="links" href="AdminController?action=category" style="margin-left: 100px">Back to Shopping</a>
                        </div>
